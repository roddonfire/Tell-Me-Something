...
MIC::MIC(String &result): _speech_data(result) {
    ...
    AUDIO_IN = A0;
    Serial.println("Result (should be hello): " + _speech_data);
}
...
void MIC::record(int duration) {
    ...
    {                                                             //read in NUM_SAMPLES worth of audio data
        ...
        if (sample_num % 3 == 0)
        {
            if (sample_num % 10000 == 0) Serial.println(_speech_data.substring(0, 100));
    ...
    Serial.println("______________________");
    Serial.println("______________________");
    Serial.print("Note:  remaining encoding:" + _speech_data);
    Serial.println("______________________");
    Serial.println("______________________");
    Serial.println("______________________");
    Serial.println("______________________");
